...
//					out.println("【" + userName + "选择了接收文件！】");
				//	out.flush();
                    File userFile = new File("C:\\Users\\Lenovo-pc\\Desktop\\接受文件\\" + userName);
                    if(!userFile.exists()) {  // 新建当前用户的文件夹
                        userFile.mkdir();
                    }
                    File file = new File("C:\\Users\\Lenovo-pc\\Desktop\\接受文件\\" + userName + "\\"+ textName);
                  ...
                  out.println("【" + userName + "接收了文件！】");
                   out.flush();
                    ...
                    JOptionPane.showMessageDialog(chatViewJFrame, "文件存放地址：\n" +
                            "C:\\Users\\Lenovo-pc\\Desktop\\接受文件\\" +
