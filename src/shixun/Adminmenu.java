     ...
     ju1 = new JButton("查询");
      ...
      jo4 = new JButton("修改");
       ...
       jk1 = new JButton("查询");
        ...
        Object[][] table9 = new Object[40][9];
        Object[] name9 = {"id","用户名","登录密码","姓名","性别","出生日期","电话号码","电子邮箱","个人简介"};
        JPanel p7 = new JPanel();
        p7.setLayout(null);
        p7.setBounds(0, 100, 900, 500);
        JTable d9=new JTable(table9,name9);
        d5.setRowHeight(30);
        JScrollPane js9 = new JScrollPane(d9);
        js9.setBounds(0, 0, 800, 400);
        p7.add(js9);
        jod = new JButton("查询全部");
        jod.setIcon(new ImageIcon("C:\\Users\\Lenovo-pc\\IdeaProjects\\ShiXun\\src\\image\\2.png"));
        jod.setBounds(830, 35, 120, 35);
        jod.setFont(new Font("黑体", 0, 15));
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                try {
                    ...
                    for (int i = 0; rs.next(); i++) {
                        ...
                        d9.setValueAt(Integer.toString(id),i,0);
                        d9.setValueAt(uname, i, 1);
                        d9.setValueAt(pwd, i, 2);
                        d9.setValueAt(pname, i, 3);
                        d9.setValueAt(sex, i, 4);
                        d9.setValueAt(birth, i, 5);
                        d9.setValueAt(tel, i, 6);
                        d9.setValueAt(email, i, 7);
                        d9.setValueAt(intro, i, 8);
                    }
                } catch (Exception throwables) {
                    throwables.printStackTrace();
                } finally {
        ...
        p7.add(jod);
         jo1d = new JButton("查询");
        jo1d.setBounds(830, 80, 120, 35);
        jo1d.setIcon(new ImageIcon("C:\\Users\\Lenovo-pc\\IdeaProjects\\ShiXun\\src\\image\\3.png"));
        jo1d.setFont(new Font("黑体", 0, 15));
        jo1d.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent actionEvent) {
                String st1 = JOptionPane.showInputDialog(null, "编号", "查询", 1);
                System.out.println(st1);
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        if (st1.equals(a)) {
                            ...
                            String email=rs.getString(8);
                            String  intro=rs.getString(9);
                            d9.setValueAt(Integer.toString(id),0,0);
                            d9.setValueAt(uname, 0, 1);
                            d9.setValueAt(pwd, 0, 2);
                            d9.setValueAt(pname, 0, 3);
                            d9.setValueAt(sex, 0, 4);
                            d9.setValueAt(birth, 0, 5);
                            d9.setValueAt(tel, 0, 6);
                            d9.setValueAt(email, 0, 7);
                            d9.setValueAt(intro, 0, 8);
                        }
                    }
                    if (m == 0) {
                        JOptionPane.showMessageDialog(null, "您查找的数据不存在", "提示：", JOptionPane.ERROR_MESSAGE);
        ...
        p7.add(jo1d);
         jo2d = new JButton("增加");
        jo2d.setIcon(new ImageIcon("C:\\Users\\Lenovo-pc\\IdeaProjects\\ShiXun\\src\\image\\5.png"));
        jo2d.setBounds(830, 125, 120, 35);
        jo2d.setFont(new Font("黑体", 0, 15));
        jo2d.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent actionEvent) {
                JDialog jd1 = new JDialog();
                jd1.setLayout(null);
                ...
                jd1.add(ja1 );
                JLabel jLabeld=new JLabel("1为用户，0为管理员");
                jLabeld.setBounds(130,79,170,30);
                jLabeld.setForeground(Color.red);
                jd1.add(jLabeld);
                JTextField jt1=new JTextField();
                jt1.setColumns(20);
                jt1.setBounds(130,58,100,25);
        ...
        p7.add(jo2d);
         jo3d = new JButton("删除");
        jo3d.setIcon(new ImageIcon("C:\\Users\\Lenovo-pc\\IdeaProjects\\ShiXun\\src\\image\\5.png"));
        jo3d.setBounds(830, 170, 120, 35);
        jo3d.setFont(new Font("黑体", 0, 15));
        jo3d.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent actionEvent) {
                int row=d9.getSelectedRow();
                if(row!=-1) {
                    int result = JOptionPane.showConfirmDialog(null, "确定要删除吗？","请确认",JOptionPane.YES_NO_OPTION);
                    if(result==JOptionPane.OK_OPTION)
                    {
                        try {
                            String sql = "DELETE FROM userinfo WHERE uname"+"='"+d9.getValueAt(row,1).toString()+"'";
                            PreparedStatement preparedStatement = con.prepareStatement(sql);
                            preparedStatement.executeUpdate();
                        } catch (Exception throwables) {
                            throwables.printStackTrace();
        ...
        jo4d = new JButton("修改");
        jo4d.setIcon(new ImageIcon("C:\\Users\\Lenovo-pc\\IdeaProjects\\ShiXun\\src\\image\\6.png"));
        jo4d.setBounds(830, 215, 120, 35);
        jo4d.setFont(new Font("黑体", 0, 15));
        jo4d.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed (ActionEvent act) {
                int row=d9.getSelectedRow();
                if(row!=-1) {
                    ...
                    if(result==JOptionPane.OK_OPTION)
                    {
                        ...
                        jd1.add(ja1 );
                        JTextField jt1=new JTextField();
                        jt1.setText(d9.getValueAt(row,0).toString());
                        jt1.setColumns(20);
                        jt1.setBounds(130,58,100,25);
                        jd1.add(jt1 );
                        ...
                        jd1.add(ja2 );
                        JTextField jt2=new JTextField();
                        jt2.setText(d9.getValueAt(row,1).toString());
                        jt2.setColumns(20);
                        jt2.setBounds(130,128,100,25);
                        jd1.add(jt2 );
                        ...
                        jd1.add(ja22);
                        JTextField jt22=new JTextField();
                        jt22.setText(d9.getValueAt(row,2).toString());
                        jt22.setColumns(20);
                        jt22.setBounds(130,190,100,25);
                        jd1.add(jt22);
                        ...
                        jd1.add(ja3 );
                        JTextField jt3=new JTextField();
                        jt3.setText(d9.getValueAt(row,3).toString());
                        jt3.setColumns(20);
                        jt3.setBounds(130,250,100,25);
                        jd1.add(jt3 );
                        JLabel ja4=new JLabel("性别:");
                        ...
                        JTextField jt4=new JTextField();
                        jt4.setText(d9.getValueAt(row,4).toString());
                        jt4.setColumns(20);
                        jt4.setBounds(130,310,100,25);
                        jd1.add(jt4);
                        ...
                        jd1.add(ja5 );
                        JTextField jt5=new JTextField();
                        jt5.setText(d9.getValueAt(row,5).toString());
                        jt5.setColumns(20);
                        jt5.setBounds(130,370,100,25);
                        jd1.add(jt5);
                        ...
                        jd1.add(ja6);
                        JTextField jt6=new JTextField();
                        jt6.setText(d9.getValueAt(row,6).toString());
                        jt6.setColumns(20);
                        jt6.setBounds(130,430,100,25);
                        jd1.add(jt6);
                        ...
                        jd1.add(ja7 );
                        JTextField jt7=new JTextField();
                        jt7.setText(d9.getValueAt(row,7).toString());
                        jt7.setColumns(20);
                        jt7.setBounds(130,490,100,25);
                        jd1.add(jt7);
                        ...
                        jd1.add(ja8);
                        JTextField jt8=new JTextField();
                        jt8.setText(d9.getValueAt(row,8).toString());
                        jt8.setColumns(20);
                        jt8.setBounds(130,550,100,25);
                        jd1.add(jt8);
                        ...
                        jb.addActionListener(new ActionListener() {
                            ...
                            public void actionPerformed(ActionEvent actionEvent) {
                                ...
                                try {
                                    ...
                                    String sql="update userinfo set id="+a+","+"uname='"+b+"',"+"pwd='"+c+"',"+"pname='"+d+"',"+"sex='"+e+
                                            "',"+"birth='"+f+"',"+"tel='"+g+"',"+"email='"+h+ "',"+"intro="+"'"+k+"'"
                                            +" where id="+Integer.parseInt(d9.getValueAt(row,0).toString());
                                    PreparedStatement preparedStatement= con.prepareStatement(sql);
                                    preparedStatement.executeUpdate();
                                }catch (Exception throwables) {
                                    throwables.printStackTrace();
        ...
        jod.addActionListener(this);
        jo1d.addActionListener(this);
        jo2d.addActionListener(this);
        jo3d.addActionListener(this);
        jo4d.addActionListener(this);
        p7.add(jo4d);
        jtb.add("用户管理", p7);
...
//        jtb.add("交流", p8);
        ...
        p6.setLayout(null);
        p6.setBounds(0, 100, 800, 500);
        JLabel jLabel=new JLabel("这 里 是 系 统 日 志");
        jLabel.setIcon(new ImageIcon("C:\\Users\\Lenovo-pc\\eclipse-workspace\\shixun1\\src\\assets\\h.png"));
        jLabel.setFont(new Font("微雅软黑",4,30));
        jLabel.setBounds(390,5,300,50);
        p6.add(jLabel);
        JLabel jLabel1=new JLabel("注意：系统日志为只读");
        jLabel1.setFont(new Font("微雅软黑",4,15));
        jLabel1.setBounds(430,45,200,50);
        jLabel1.setForeground(Color.red);
        p6.add(jLabel1);
        //p6.setBackground(Color.YELLOW);
        JTextArea jtf=new JTextArea();
        jtf.setFont(new Font("黑体", 5,25));
        //jtf.setBounds(30,25,400,105);
        //p6.add(jtf);
        JButton jButtond=new JButton("刷新");
        jButtond.setBounds(800,69,90,30);
        p6.add(jButtond);
        JScrollPane jscr = new JScrollPane(jtf);
        jscr.setBounds(200, 100, 800, 450);
        p6.add(jscr);
        ...
        jButtond.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                jtf.setText("");
                try {
                    BufferedReader br1 = new BufferedReader(new FileReader("lib/3.txt"));
